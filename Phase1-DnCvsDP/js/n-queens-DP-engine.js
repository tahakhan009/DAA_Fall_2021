...
class NQueensDPEngine{
    ...
    crossOver(dna1, dna2){
        const [a, b] = DPAlgorithm.crossOver.TwoPoint(dna1, dna2);
    ...
    *run(){
        ...
        do{
            ...
            const selectedIndexes = Array(generation.length).fill(0).map(() => DPAlgorithm.selection.RouletteWheel(fitnesses));
            const pairedIndexes = DPAlgorithm.pairing.Fitness(selectedIndexes, (index) => fitnesses[index]);
